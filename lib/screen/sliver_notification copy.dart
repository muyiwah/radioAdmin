...
class _NotificatState extends State<Notificat> {
  final String _content =
      'Trcc Radio is live, connect using trccradio.web.app or download trccradio app from playstore';
                  ...
                  ElevatedButton(
                    onPressed: () {
                      setState(() {
                        ...
                        if (passwordText.text != 'admin@trccradio') {
                        ...
                        if (_minLength.text.length > 3 &&
                            ...
                            passwordText.text == 'admin@trccradio') {
                          _minLength.text = '';
